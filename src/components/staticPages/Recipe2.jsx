		...
		return (
			<div className="description">
				...
				<h5>
					...
					<br></br>
					2. In a large skillet melt 2 tablespoons of butter over medium-high heat. Cook chicken breasts until golden on each side and cooked through – about 3-4 minutes for each side, depending on the thickness of your chicken breasts. Transfer to a plate.
				</h5>
